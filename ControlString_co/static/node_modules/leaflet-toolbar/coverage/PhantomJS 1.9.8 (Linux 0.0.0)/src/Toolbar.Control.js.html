...
<html lang="en">
<head>
    <title>Code coverage report for src/Toolbar.Control.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/Toolbar.Control.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; Toolbar.Control.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">L.Toolbar.Control = L.Toolbar.extend({
	statics: {
...
&nbsp;
	onRemove: function(map) {
		...
		<span class="missing-if-branch" title="if path not taken" >I</span>if (this._control.remove) {<span class="cstat-no" title="statement not covered" >this._control.remove();}</span>  // Leaflet 1.0
