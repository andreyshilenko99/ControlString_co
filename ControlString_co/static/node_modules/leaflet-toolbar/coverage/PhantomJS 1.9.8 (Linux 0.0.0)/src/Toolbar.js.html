...
<html lang="en">
<head>
    <title>Code coverage report for src/Toolbar.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/Toolbar.js</span></h1>
    <h2>
        
        Statements: <span class="metric">87.76% <small>(43 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">src/</a> &#187; Toolbar.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">L.Toolbar = (L.Layer || L.Class).extend({
	statics: {
...
&nbsp;
	options: {
		className: '',
		filter: <span class="fstat-no" title="function not covered" >function() {</span> <span class="cstat-no" title="statement not covered" >return true; </span>},
		actions: []
	},
&nbsp;
...
&nbsp;
		if (this._calculateDepth() === 0) {
			<span class="missing-if-branch" title="if path not taken" >I</span>if (currentToolbar) { <span class="cstat-no" title="statement not covered" >map.removeLayer(currentToolbar); </span>}
...
&nbsp;
	onRemove: function(map) {
		...
		// }
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this._calculateDepth() === 0) {
...
&nbsp;
		return Action.extend({
			...
			enable: <span class="fstat-no" title="function not covered" >function(e) {</span>
				/* Ensure that only one action in a toolbar will be active at a time. */
<span class="cstat-no" title="statement not covered" >				if (toolbar._active) { <span class="cstat-no" title="statement not covered" >toolbar._active.disable(); </span>}</span>
<span class="cstat-no" title="statement not covered" >				toolbar._active = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >				Action.prototype.enable.call(this, e);</span>
			}
		});
	},
&nbsp;
